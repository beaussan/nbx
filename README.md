...
@beaussan/nbx/2.0.2 linux-x64 node-v13.7.0
$ nbx --help [COMMAND]
USAGE
  $ nbx COMMAND
...
...
_See code: [src/commands/add/prettier.ts](https://github.com/beaussan/nbx/blob/v2.0.2/src/commands/add/prettier.ts)_
...
_See code: [src/commands/wall/index.ts](https://github.com/beaussan/nbx/blob/v2.0.2/src/commands/wall/index.ts)_
